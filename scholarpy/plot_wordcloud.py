...
#    words are colored with a custom colour.
#
...
def main():
    ...
    parser.add_argument("--plot_colormap", default="viridis", help="Matplotlib colourmap for gradient colouring (optional, default: `viridis`).")
    ...
    parser.add_argument("--special_color", default="green", help="Colour to highlight special words (optional, default: `green`).")
